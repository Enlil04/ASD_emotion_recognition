...
class _TherapistSignUpState extends State<TherapistSignUp> {
  ...
  final _clinicC = TextEditingController();
  bool _loading = false;
  @override
  void dispose() {
    _firstNameC.dispose();
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 16.0,),
                  _buildTextField(field: "Licence Number", icon: Icons.edit_document, controller: _licenseC),
                  SizedBox(height: 16.0,),
                  _buildTextField(field: "Clinic / Organization Name", icon: Icons.home_repair_service_rounded, controller: _clinicC),
                  SizedBox(height: 16.0,),
                 ...
                 onPressed: _loading ? null : () async {
                      ...
                      final license = _licenseC.text.trim();
                      final clinic = _clinicC.text.trim();
                      ...
                      try {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(content: Text("Therapist account created. Please login.")),
                        );
