...
// // Enhanced ASD-Friendly Bubble Breathing Game with Settings
...
//     if (currentPhase == 'Breathe In') {
//       // Inhaling: eyes slowly close (1.0 -> 0.0)
//       // Use animation progress within the phase
//       eyeOpenness = 1.0 - (animationValue - 0.5) * 2.0;
//       eyeOpenness = eyeOpenness.clamp(0.0, 1.0);
//     } else if (currentPhase == 'Hold') {
//       // Holding breath: keep eyes closed
//       eyeOpenness = 0.0;
//     } else if (currentPhase == 'Breathe Out') {
//       // Exhaling: eyes slowly open (0.0 -> 1.0)
//       eyeOpenness = (animationValue - 0.5) * 2.0;
//       eyeOpenness = eyeOpenness.clamp(0.0, 1.0);
//     } else if (currentPhase == 'Rest') {
//       // Resting: keep eyes open
//       eyeOpenness = 1.0;
...
// //     // Calculate eye openness based on animation value
// //     // animationValue goes 0.5 -> 1.0 -> 0.5 throughout the cycle
// //     // We want eyes to close during inhale (0.5 -> 1.0) and open during exhale (1.0 -> 0.5)
// //     double eyeOpenness;
// //     if (animationValue < 0.75) {
// //       // First half: inhale (closing eyes)
// //       eyeOpenness = 1.0 - ((animationValue - 0.5) / 0.25);
// //     } else {
// //       // Second half: exhale (opening eyes)
// //       eyeOpenness = ((animationValue - 0.75) / 0.25);
// //     }
// //     eyeOpenness = eyeOpenness.clamp(0.0, 1.0);
...
// //       leftEyePath.quadraticBezierTo(
// //         center.dx - eyeSpacing,
// //         eyeY + eyeRadius * 0.5 * eyeOpenness,
// //         center.dx - eyeSpacing + eyeRadius,
// //         eyeY,
// //       );
// //       canvas.drawPath(leftEyePath, eyePaint);
...
// // //     // Determine breathing phase based on animation value
// // //     // 0.0-0.5: growing (inhale)
// // //     // 0.5-1.0: shrinking (exhale)
// // //     final isInhaling = animationValue < 0.75;
// // //     final isExhaling = animationValue >= 0.75;

// // //     // Draw eyes based on phase
// // //     if (isInhaling) {
// // //       // Open eyes during inhale
// // //       canvas.drawOval(
// // //         Rect.fromCenter(
// // //           center: Offset(center.dx - eyeSpacing, eyeY),
// // //           width: eyeRadius * 1.5,
...
// // //       );
// // //     } else {
// // //       // Closed/relaxed eyes during exhale and hold
// // //       final eyePaint = Paint()
// // //         ..color = AppColors.titletext
// // //         ..style = PaintingStyle.stroke
// // //         ..strokeWidth = radius * 0.04
...
// // //     // Draw mouth based on phase
// // //     final smilePath = Path();
// // //     final smileWidth = radius * 0.5;
// // //     final smileY = center.dy + radius * 0.15;

// // //     if (isInhaling) {
// // //       // Small "O" mouth during inhale (breathing in)
// // //       final mouthRadius = radius * 0.1;
// // //       canvas.drawCircle(
// // //         Offset(center.dx, smileY + radius * 0.05),
// // //         mouthRadius,
// // //         Paint()
// // //           ..color = AppColors.titletext
// // //           ..style = PaintingStyle.stroke
...
// // //       );
// // //     } else {
// // //       // Relaxed smile during exhale and hold
// // //       final smileHeight = radius * 0.15;
// // //       smilePath.moveTo(center.dx - smileWidth / 2, smileY);
// // //       smilePath.quadraticBezierTo(
// // //         center.dx,
...
// // // // // // ASD-Friendly Bubble Breathing Game
// // // // // // Features:
...
// // // // // // - Optional sound (can be toggled)

// // // // // class BubbleBreathingGame extends StatefulWidget {
// // // // //   const BubbleBreathingGame({Key? key}) : super(key: key);

// // // // //   @override
// // // // //   State<BubbleBreathingGame> createState() => _BubbleBreathingGameState();
// // // // // }

// // // // // class _BubbleBreathingGameState extends State<BubbleBreathingGame>
// // // // //     with SingleTickerProviderStateMixin {
// // // // //   late AnimationController _controller;
// // // // //   late Animation<double> _animation;
...
// // // // //   // Customizable breathing timings (in seconds)
// // // // //   final double _inhaleTime = 4.0;
// // // // //   final double _holdTime = 2.0;
// // // // //   final double _exhaleTime = 4.0;
// // // // //   final double _pauseTime = 2.0;
...
// // // // // // class BubbleBreathingGame extends StatefulWidget {
// // // // // //   const BubbleBreathingGame({super.key});
...
// // // // // //   // State to handle text instructions
...
// // // // // //     // 4 seconds in, 4 seconds out is a calming rhythm (Box Breathing style)
// // // // // //     _controller = AnimationController(
// // // // // //       vsync: this,
...
// // // // // //     // Listen to status to update text
// // // // // //     _controller.addStatusListener((status) {
...
// // // // // //               mainAxisAlignment: MainAxisAlignment.center,
// // // // // //               children: [
// // // // // //                 // The Breathing Bubble Animation
// // // // // //                 AnimatedBuilder(
...
// // // // // // // --- VISUAL COMPONENT: THE CUTE FACE ---
// // // // // // class CuteFace extends StatelessWidget {
// // // // // //   const CuteFace({super.key});
